#############################################################################
# Makefile for building: voron
# Generated by qmake (3.0) (Qt 5.4.0)
# Project:  voron.pro
# Template: app
# Command: /home/denesik/Qt/5.4/gcc_64/bin/qmake -spec linux-g++ -o Makefile voron.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = voron1.0.0
DISTDIR = /home/denesik/dev/sge/voron/.tmp/voron1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/denesik/Qt/5.4/gcc_64
LIBS          = $(SUBLIBS)  
AR            = ar cqs
RANLIB        = 
SED           = sed
...
Makefile: voron.pro ../../../Qt/5.4/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt/5.4/gcc_64/mkspecs/features/spec_pre.prf \
		../../../Qt/5.4/gcc_64/mkspecs/common/shell-unix.conf \
		../../../Qt/5.4/gcc_64/mkspecs/common/unix.conf \
		../../../Qt/5.4/gcc_64/mkspecs/common/linux.conf \
		../../../Qt/5.4/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../../Qt/5.4/gcc_64/mkspecs/features/lex.prf \
		voron.pro
	$(QMAKE) -spec linux-g++ -o Makefile voron.pro
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/voron/bin || mkdir -p $(INSTALL_ROOT)/opt/voron/bin
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/opt/voron/bin/$(QMAKE_TARGET)"
	-$(STRIP) "$(INSTALL_ROOT)/opt/voron/bin/$(QMAKE_TARGET)"

uninstall_target: FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/opt/voron/bin/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/voron/bin/ 
